...
public class AddActActivity1 extends AppCompatActivity implements View.OnClickListener {
...
//    private EditText et_greenconfrequency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_actplan1);
...
//        greenconfrequency = et_greenconfrequency.getText().toString().trim();
        ...
        if(TextUtils.isEmpty(redrefrequency)){
            Toast.makeText(AddActActivity1.this, "Please input Something", Toast.LENGTH_SHORT).show();
            return;
...
//            }
            ...
            //ActDB actDB1 = LitePal.findAll(ActDB.class,"greenrename","greenredosage");
//            actDB1.setActID(actID);
            //et_greenrename = findViewById(R.id.et_greenrename);
//            SharedPreferences preferences = getSharedPreferences("greenrename",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greenredosage",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greenreform",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greenrefrequency",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greenconname",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greencondosage",MODE_PRIVATE);
//            SharedPreferences preferences = getSharedPreferences("greenconform",MODE_PRIVATE);
            SharedPreferences preferences = getSharedPreferences("greenconfrequency",MODE_PRIVATE);

            greenrename = preferences.getString("greenrename","");
           // et_greenredosage = findViewById(R.id.et_greenredosage);
            greenredosage = preferences.getString("greenredosage","");
           // et_greenreform = findViewById(R.id.et_greenreform);
            greenreform = preferences.getString("greenreform","");
           // et_greenrefrequency = findViewById(R.id.et_greenrefrequency);
            greenrefrequency = preferences.getString("greenrefrequency","");

            //et_greenconname = findViewById(R.id.et_greenconname);
            greenconname = preferences.getString("greenconname","");
           // et_greencondosage = findViewById(R.id.et_greencondosage);
            greencondosage = preferences.getString("greencondosage","");
           // et_greenconform = findViewById(R.id.et_greenconform);
            greenconform = preferences.getString("greenconform","");
           // et_greenconfrequency = findViewById(R.id.et_greenconfrequency);
            greenconfrequency = preferences.getString("greenconfrequency","");
...
//            finish();
            ...
            startActivity( new Intent( AddActActivity1.this, ActActivity.class ) );
            AddActActivity1.this.finish();
