...
public class yellowzone {
    ...
    public yellowzone(int id,String c_medication,String c_dose,String c_form,String c_freq,String r_medication,String r_dose,String r_form,String r_freq,int WorkersId){
